...
public class FrageServiceImpl implements FrageService {
    ...
    //um die Ergebnisse nach der Kategorie und dann nach der Punktzahl aufsteigend zu sortieren
    @Override
    public List<Frage> holeAlleFragen() {
        Sort sort = Sort.by("kategorie").ascending().and(Sort.by("punktzahl").ascending());//ascending()->Sortierung in aufsteigender Reihenfolge 
    ...
    //speichert die übergebene Frage in der Datenbank und gibt das gespeicherte Frage-Objekt zurück
    @Override
